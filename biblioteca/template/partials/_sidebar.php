  ...
  <ul class="nav">
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="../template/pages/livro/cad_livro.php">Cadastrar</a></li>
          <li class="nav-item"> <a class="nav-link" href="../template/pages/livro/atualiza_livro.php">Atualizar</a></li>
        </ul>
      </div>
    </li>
    ...
    <li class="nav-item menu-items">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="../template/pages/usuario/cad_usuario.php"> Cadastrar </a></li>
          <li class="nav-item"> <a class="nav-link" href="../template/pages/usuario/atualiza_usuario.php"> Atualizar </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item menu-items">
